...
--    awful.key({ modkey, }, "w", function () awful.util.spawn( "firefox" ) end,
  --            {description = "firefox", group = "application"}),
    awful.key({ modkey }, "d", function () awful.spawn(string.format("dmenu_run -i -nb '#2b303e' -nf '#c0c5ce' -sb '#65737e' -sf '#000000' -fn NotoMonoRegular:pixelsize=15" ))	end,
...
-- My Personal Startups
awful.spawn.with_shell("feh --bg-scale ~/Pictures/wall/SW-luke.jpg")
awful.spawn.with_shell("xrandr --output HDMI-1 --same-as LVDS-1")
awful.spawn.with_shell({ "xset s off", "xset dpms 60000 60000 60000"})
awful.spawn.with_shell("picom -bf --config  /home/larry/.config/picom/picom.conf")
